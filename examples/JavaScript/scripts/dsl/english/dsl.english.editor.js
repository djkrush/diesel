CodeMirror.defineMode("english", function (config, parserConfig) {
	...
	return {
		language: dsl.english.language,
        token: function (stream) {
        	var result = null,
                dslTokens = dsl.english.tokens.dictionary,
				isKeyword = false,
				isLiteral = false,
...
CodeMirror.defineMIME("english", "english");
